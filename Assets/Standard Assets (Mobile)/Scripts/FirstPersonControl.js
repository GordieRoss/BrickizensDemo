...
function Start()
{
anim = GameObject.Find("FPSBrickizen").GetComponent(Animator);
...
//	GameObject.Find("MoveText").GetComponent(GUIText).guiText.text = movement.x.ToString();
	
if (movement.x != 0){
//Change animation state to walking
anim.SetFloat("Movement",1.0);
}
else{
//Change animation state to idle
anim.SetFloat("Movement",0.0);
